...
import cn.fuego.tinder.main.util.engine.jxl.exception.ExcelReaderException;
import cn.fuego.tinder.main.util.engine.jxl.exception.msg.ExcelReaderExceptionMsg;
...
public class ExcelReader {
	...
	private void excelLoad() {
	    ...
	    try {
			...
			if (book == null) {
				throw new ServiceException(ExcelReaderExceptionMsg.EXCEL_OPEN_ERR);
			}
