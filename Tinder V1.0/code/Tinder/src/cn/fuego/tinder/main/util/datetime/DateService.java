package cn.fuego.tinder.main.util.datetime;
...
import cn.fuego.tinder.main.util.datetime.exception.DateTimeServiceException;
import cn.fuego.tinder.main.util.datetime.exception.msg.DateTimeServiceExceptionMsg;
...
public class DateService {
	...
	public static Date stringToDate(String date) {
		...
		try {
			...
			throw new DateTimeServiceException(DateTimeServiceExceptionMsg.DATE_FOMATE);
